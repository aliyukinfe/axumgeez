          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_340px]">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href="/downloads/AxumGeezSetup.exe" className="inline-flex items-center justify-center gap-2 rounded-full bg-blue-primary px-6 py-3.5 font-bold text-white shadow-blue transition-colors hover:bg-blue-deep">
                  <Download className="h-5 w-5" aria-hidden="true" />
                  Download for Windows
                </Link>
                <span className="inline-flex items-center justify-center rounded-full border border-line px-6 py-3.5 font-bold text-ink">Coming soon if file is unavailable</span>
              </div>
            </div>
            <aside className="rounded-2xl bg-surface-light p-6">
              <h2 className="text-xl font-black text-ink">Version 1.0.0</h2>
              <p className="mt-2 text-sm leading-6 text-ink/64">File placeholder: /downloads/AxumGeezSetup.exe</p>
